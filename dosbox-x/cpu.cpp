...
//this is our code to toggle emulation speeds

int num_steps = 11;
unsigned int steps[12] = {240, 750, 1510, 2000, 3300, 4595, 6075, 12019, 23880, 33445, 43500, 97240};
int current_step = 3;
...
void CPU_CycleIncrease(bool pressed) {
	...
	if (CPU_CycleAutoAdjust) {
		...
		if (current_step < num_steps)
		  current_step++;
	        CPU_CycleMax = steps[current_step];
		LOG_MSG("Step: %d", current_step);
